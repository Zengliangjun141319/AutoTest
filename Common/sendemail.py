...
<body leftmargin="8" marginwidth="0" topmargin="8" marginheight="4"    
    ...
    # 邮件附件
    try:
        # file = r'.\\report\\result_2021.09.10.203036.115\\result_2021.09.10.203036.115.html'
        attRe = MIMEText(open(report, 'rb').read(), 'html', 'utf-8')
        attRe["Content-Type"] = 'text/html'
        # attRe["Content-Disposition"] = 'attachment; filename"TestReport.html" '
        # 中文附件名处理方式
...
if __name__ == '__main__':
    ...
    version = '2.21.908'
    reoprtf = r'./report/result_2022.01.18.200016.601.html'
    # sendEmail(version, reoprtf, runtime=nowtime)
    reportScreenshot(reoprtf)