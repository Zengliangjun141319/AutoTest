...
<a class="failed  detail_button" href='javascript:showCase(2,%(channel)s)'>Fail[%(fail)s]</a>
...
"""  # variables: (id, output)
    ...
    IMG_TMPL = r"""
        <a  onfocus='this.blur();' href="javascript:void(0);" onclick="show_img(this)">show Screenshots</a>
...
class MergeResult(Template_mixin):
    ...
    def init_rows(self, c_id, current_result):
        ...
        for cid, (cls, cls_results) in enumerate(sortedResult):
            ...
            self.totle_count += current_result.success_count + current_result.failure_count + current_result.error_count + current_result.skip_count
