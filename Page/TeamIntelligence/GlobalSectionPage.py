...
class GlobalSectionPage(Operater):
    ...
    globalsection_loc = ('xpath', '//*[@id="set_left"]/ul/li[2]/a/span')
    ...
    displayinput_loc = ('xpath', '//*[@id="right_popup"]/div/div[2]/div/table/tbody/tr[2]/td[2]/input')
    ...
    savemsg_loc = ('xpath', 'html/body/div[18]/div[2]/div')
    saveok_loc = ('xpath', 'html/body/div[18]/div[3]/input')