...
class ManageAssetsPage(Operater):
    ...
    # SearchButton_loc = ('value', 'Search')
    SearchButton_loc = ('xpath', '//*[@id="recordcontent"]/div[2]/input[2]')
    ...
    importOk_loc = ('xpath', '/html/body/div[@class="dialog popupmsg"]/div[@class="dialog-func"]/input')

    ListHideck_loc = ('xpath', '//*[@id="machinelist"]/div/div/div/table/tbody/tr/td[13]/input')

    # 新建编辑机器页面元素
    iframemachine = ('id', 'iframemachine')    # 机器编辑界面
    SaveButton_loc = ('xpath', '//*[@id="div_content"]/div[2]/span[1]')        # 保存
    SaveExitButton_loc = ('xpath', '//*[@id="div_content"]/div[2]/span[2]')    # 保存并退出
    ExitSaveButton_loc = ('xpath', '//*[@id="div_content"]/div[2]/span[3]')    # 不保存退出
    ...
    ResetLayoutOk_loc = ('xpath', '/html/body/div[@class="dialog popupmsg"]/div[@class="dialog-func"]/input[2]')
