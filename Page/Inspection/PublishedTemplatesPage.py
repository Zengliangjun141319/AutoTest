...
class PublishedTemplatesPage(Operater):
    ...
    publishedTemplates_loc = ('link text', 'Published')    # Published Templates菜单
    daftTemplates_loc = ('link text', 'Draft')  # Draft Templates菜单
    ...
    # 复制Template相关元素
    copyBtn_loc = ('xpath','//*[@id="set_right"]/div/div[3]/div[@class="question-holder"]/div[@class="question-cell template-func"]/em[3]') # 复制按钮
    ...
    # 删除Template相关元素
    deleteBtn_loc = ('xpath','//*[@id="set_right"]/div/div[3]/div[@class="question-holder"]/div[@class="question-cell template-func"]/em[2]') # 删除按钮
