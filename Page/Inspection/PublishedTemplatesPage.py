...
class PublishedTemplatesPage(Operater):
    # 左侧滑块大图标
    inspection_loc = ('xpath', '//*[@id="divLeftTitle"]/div[@title="Inspection"]')

    # Asset Scheduling菜单元素
    exButton_loc = ('xpath', '//*[@id="nav_arrow"]')    # 左边菜单收折按钮
    publishedTemplates_loc = ('xpath', '//*[@id="set_left"]/ul/li[@title="Published"]')    # Published Templates菜单
    daftTemplates_loc = ('xpath', '//*[@id="set_left"]/ul/li[@title="Draft"]')  # Draft Templates菜单

    # Templates列表元素
    addBtn_loc = ('xpath', '//*[@id="set_right"]/div/div[1]/div[@class="function_title"]/span[1]')  # 添加按钮
    refresh_loc = ('xpath', '//*[@id="set_right"]/div/div[1]/div[@class="function_title"]/span[2]')
    ...
    '''添加Template相关元素'''
    # Summary部分的元素
    summarys = '//*[@id="right_popup"]/div/div[2]/div[1]/div/table/'
    templateName_loc = ('xpath', summarys + 'tr[1]/td[2]/input')
    locationEnabled_loc = ('xpath', summarys + 'tr[2]/td[2]/input[1]')
    signatureRequired_loc = ('xpath', summarys + 'tr[2]/td[2]/input[2]')
    forWorkOrder_loc = ('xpath', summarys + 'tr[2]/td[2]/input[3]')
    ...
    copyTemplateName_loc = ('xpath', '//div[@class="dialog"][@init="1"]/div[2]/table/tr/td[2]/input')
    copyOKBtn_loc = ('xpath', '//div[@class="dialog"][@init="1"]/div[3]/input[2]')  # 复制对话框中的OK按钮
    ...
    # 发布Template相关元素
    publishBtn_loc = ('xpath', '//em[@class="spanbtn iconshare"]')
