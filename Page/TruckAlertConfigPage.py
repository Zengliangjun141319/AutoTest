...
class TruckAlertPage(Operater):
    ...
    assettype_loc = ('xpath', ".//*[@id='dialog_assettype']/div/div/span[1]") # Acceptable asset type选择框
    typeselect_loc = ('id', "chkp11")  # 下拉选择列表第11个选项
    ...
    savemsg_loc = ('xpath', "html/body/div[3]/div[2]/div")  # 保存成功提示信息
    savemsgok_loc = ('xpath', "html/body/div[3]/div[3]/input") # 保存提示信息OK按钮
    ...
    delOk_loc = ('xpath', '/html/body/div[@class="dialog popupmsg"]/div[@class="dialog-func"]/input[2]')