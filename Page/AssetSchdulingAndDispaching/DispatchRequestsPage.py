...
class DispatchRequestsPage(Operater):
    ...
    # Email功能相关元素
    asset1_loc = ('xpath', '//*[@id="dispatchlist"]/div/div/div/table/tbody/tr[1]/td[1]/%s' % grid_ck) # 列表中的第一个机器
    asset2_loc = ('xpath', '//*[@id="dispatchlist"]/div/div/div/table/tbody/tr[2]/td[1]/%s' % grid_ck)  # 列表中的第二个机器
    emailBtn_loc = ('xpath', '//*[@id="contentctrl"]/div[@class="function_title"]/span[1]') # Email按钮
    selectAssetList_loc = ('xpath', '//*[@id="dialog_assignasset"]/div/div[1]/label[2]')  # Dispatch Assignment对话框中的下拉按钮
    ...
    sendEmailDialogOKBtn_loc = ('xpath', ok_btn)  # Send Dispatch Request对话框上的OK按钮
    ...
    deleteDialogYesBtn_loc = ('xpath', yes_btn)  # Delete对话框Yes按钮
