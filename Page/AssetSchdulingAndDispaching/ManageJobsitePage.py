...
class ManageJobsitePage(Operater):
    ...
    importOKBtn_loc = ('xpath','/html/body/div[@class="dialog popupmsg"]/div[@class="dialog-func"]/input') # Import对话框OK按钮
    ...
    nameCol_loc = ('xpath', '//*[@id="jobsitelist"]/div/table/tbody/tr/th[1]/div') # jobsite列表第一列
    regionCol_loc = ('xpath', '//*[@id="jobsitelist"]/div/table/tbody/tr/th[2]/div') # jobsite列表第二列
    numberCol_loc = ('xpath', '//*[@id="jobsitelist"]/div/table/tbody/tr/th[3]/div') # jobsite列表第三列

    resetLayoutBtn_loc = ('xpath', '//*[@id="contentctrl"]/div[@class="function_title"]/span[@class="sbutton iconresetlayout"]') # Reset Layout按钮
    resetLayoutOKBtn_loc = ('xpath', '/html/body/div[@class="dialog popupmsg"]/div[@class="dialog-func"]/input[2]') # Reset Layout对话框OK按钮
    ...
    assetLoc_loc = ('xpath', '//*[@id="dialog_machines"]/div[2]/div[4]/div/div/div/table/tbody/tr[1]/td[1]') # 添加机器页面第一个机器
    addAssetOKBtn_loc = ('xpath','//*[@id="dialog_machines"]/div[3]/input[2]') # 添加机器页面OK按钮
    # addAssetDilogOKBtn_loc = ('xpath','/html/body/div[4]/div[3]/input') # 添加机器对话框OK按钮
    addAssetDilogOKBtn_loc = ('xpath', '/html/body/div[@class="dialog popupmsg"]/div[3]/input')

    selectAllAssets_loc = ('xpath','//*[@id="selectedmachinelist"]/div/table/tbody/tr/th[1]/div/span/input') # Assets全选框
    deleteAssetBtn_loc = ('xpath','//*[@id="div_container"]/div[1]/div[1]/span[3]') # Assets删除按钮
    deleteAssetYesBtn_loc = ('xpath','/html/body/div[@class="dialog popupmsg"]/div[3]/input[2]') # Assets删除对话框Yes按钮
    ...
    deleteAssetDilogOKBtn_loc = ('xpath', '/html/body/div[@class="dialog popupmsg"]/div[3]/input')
    ...
    addAssetTypeDilogOKBtn_loc = ('xpath', '/html/body/div[@class="dialog popupmsg"]/div[3]/input')

    selectAllAssetTypes_loc = ('xpath','//*[@id="selectedassettypelist"]/div/table/tbody/tr/th[1]/div/span/input') # AssetTypes全选框
    deleteAssetTypeBtn_loc = ('xpath','//*[@id="div_container"]/div[2]/div[1]/span[3]') # AssetTypes删除按钮
    deleteAssetTypeYesBtn_loc = ('xpath','/html/body/div[2]/div[3]/input[2]') # AssetTypes删除对话框Yes按钮
    deleteAssetTypeDilogOKBtn_loc = ('xpath', '/html/body/div[@class="dialog popupmsg"]/div[3]/input')
    ...
    deleteDialogOkBtn_loc = ('xpath','/html/body/div[@class="dialog popupmsg"]/div[@class="dialog-func"]/input[2]')  # 删除对话框上的OK按钮
