...
class JobsiteRequirementsPage(Operater):
    ...
    assetTypeList_loc = ('xpath', '//*[@id="div_assettypes"]/div/div/span[2]') # Asset Type下拉列表
    assetType_loc= ('xpath','//*[@id="div_assettypes"]/div/div/div/ul/li[1]/input') # 具体的Jobsite
    pointOfContact_loc = ('id', 'pointofcontacttxt') # Point Of Contact:
    applyBtn_loc = ('id', 'search_requirements') # Apply按钮
    manageAssetBtn_loc = ('xpath', '//*[@id="requirementlist"]/div/div/div/div/table/tr/td[9]/a') # ManageAsset按钮
    firstAsset_loc = ('xpath','//*[@id="selectedmachinelist"]/div/div/div/table/tbody/tr[1]/td[1]/input') # 机器列表中的第一个机器
    ...
    deleteYesBtn_loc = ('xpath', '/html/body/div[@class="dialog popupmsg"]/div[@class="dialog-func"]/input[2]') # delete对话框上的Yes按钮
