...
class MaintenanceSchedulesPage(Operater):
    ...
    manageSchedule_loc = ('xpath', '//*[@id="pm_tbody"]/tr[1]/td/a[text()="Manage schedule"]')  # 列表中的Manage schedule链接

    # 如果计划未开启，则显示disabled 2023/12/20  ---zlj
    sc_disable_loc = ('xpath', '//*[@id="pm_tbody"]/tr[1]/td/div[text()="Disabled"]')

    # 添加PM页面的元素
    planName_loc = ('id', 'sc_name')
    planEnable_loc = ('id', 'sc_enabled')
    ...
    # Manage Assets相关元素
    manageAssetsBtn_loc = ('xpath', '//*[@id="pm_tbody"]/tr[1]/td/a[text()="Manage assets"]')  # Manage assets按钮
    ...
    firstAsset_loc = ('xpath', '//*[@id="dialog_assets"]/div[2]/div[5]/div/div[1]/div/table/tbody/tr[1]/td[1]/%s' % grid_ck)
    ...
    listServiceName_loc = ('xpath', '//*[@id="pm_tbody"]/tr[2]/td/table/tr/td[1]/input')  # 列表中要编辑的Service Name
    listSaveServiceBtn_loc = ('xpath', '//*[@id="pm_tbody"]/tr[2]/td/table/tr/td[8]/div[2]/input[1]') # 列表中Service的保存按钮

    # delete schedule相关元素
    deleteScheduleBtn_loc = ('xpath', '//*[@id="pm_tbody"]/tr[1]/td/a[text()="Delete"]')  # 删除schedule按钮
    deleteScheduleYesBtn_loc = ('xpath', '/html/body/div[@class="dialog popupmsg"]/div[@class="dialog-func"]/input[@value="Yes"]') # 删除对话框中的Yes按钮
