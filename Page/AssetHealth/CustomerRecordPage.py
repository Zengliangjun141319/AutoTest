...
class CustomerRecordPage(Operater):
    ...
    searchbutton_loc = ('xpath', ".//*[@id='content1']/div/div[2]/input[2]") # 查询按钮
    ...
    deletecustomeryes_loc = ('xpath', 'html/body/div[@class="dialog popupmsg"]/div[@class="dialog-func"]/input[2]')  # 删除Customer确认按钮
    ...
    assetcheckbutton_loc = ('id', "body_checkbox_row_0") # 第一台机器选择CheckBox
    ...
    # Customer保存功能元素
    savebutton_loc = ('xpath', ".//*[@id='content1']/div[2]/div[2]/span[1]")  # customer保存按钮
    saveexitbutton_loc = ('xpath', ".//*[@id='content1']/div[2]/div[2]/span[2]") # 保存退出按钮
    withoutsaveexit_loc = ('xpath', ".//*[@id='content1']/div[2]/div[2]/span[3]") # 不保存退出按钮

    # 保存后信息元素
    savemsg_loc = ('xpath', 'html/body/div[@class="dialog popupmsg"]/div[2]/div') # 保存后提示信息
    # /html/body/div[4]/div[3]/input
    savemsgok_loc = ('xpath', 'html/body/div[@class="dialog popupmsg"]/div[@class="dialog-func"]/input') # 提示信息OK 按钮
    # savemsgok_loc = ('xpath', 'html/body/div[4]/div[3]/input')